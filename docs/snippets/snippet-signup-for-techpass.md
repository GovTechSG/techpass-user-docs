...
- You must have a non-SE GSIB device.

**To sign up for a TechPass account**
  ...
  > :small_blue_diamond: If you have signed up for TechPass:
  ...
  >
  > :small_blue_diamond: If you had requested for SEED:
