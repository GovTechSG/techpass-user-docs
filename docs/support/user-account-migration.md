...
<details>
<summary style="font-size:18px">1. I received an email stating, "Your account was used for a new registration request". What does it mean?</summary>
...
2. I received an email stating, "Your disabled account was used for a new registration request". What does it mean?</summary>
...
<details>
<summary style="font-size:18px">
3. I received an email stating "Your TechPass account has been disabled and will be deleted soon". What does it mean?</summary>
...
<details>
<summary style="font-size:18px">
5. I am a vendor. How do I reset password for my TechPass account?</summary>
...
<details>
<summary style="font-size:18px">
7. How do I reset my MFA?</summary>
