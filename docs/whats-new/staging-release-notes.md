...
<details>
<summary style="font-size:20px;font-weight:bold">Tenants can retry or stop a webhook trigger on TechPass portal</summary>
...
We have fixed a bug and now vendors will receive accurate email updates. Earlier, emails sent to vendors when their email address was updated displayed incorrect special characters or missing values for user profile fields.
